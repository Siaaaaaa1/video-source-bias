...
def _run_on_single_gpu(model, batch_list_t, batch_list_v, batch_sequence_output_list, batch_visual_output_list):
    ...
    save_list_to_txt("/data/gaohaowen/workspace/InternVideo-main/InternVideo1/vector_output_time_debias/vision_vector_eval_opensora_fusion_gen.txt",list_video)
    ...
    save_list_to_txt("/data/gaohaowen/workspace/InternVideo-main/InternVideo1/vector_output_time_debias/caption_vector_eval_opensora_fusion_gen.txt",list_caption)
    sim_matrix = []
